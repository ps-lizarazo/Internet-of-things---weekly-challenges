...
const char MQTT_PUB_TOPIC1[] = "humedad/vancouver/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/vancouver/" HOSTNAME;
//Tópico al que se enviarán los datos de luminocidad
const char MQTT_PUB_TOPIC3[] = "luminosidad/vancouver/" HOSTNAME;
...
void loop()
{
  ...
  float intensity = light_intensity(analogRead(A0)); // Gets the value of light intensity
  ...
  //JSON para luminancia
  json = "{\"value\": "+ String(intensity) + "}";
